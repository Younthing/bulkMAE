...
helpers. Its default text sizes are designed for the recommended
physical dimensions used by
[`plot_save()`](https://younthing.github.io/bulkMAE/reference/plot_save.md).
Add ordinary ggplot2 themes or scales to a returned plot to replace any
part of it.
