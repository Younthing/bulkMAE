...
test_that("public API follows discoverable analysis families", {
  ...
  expected <- c(
    ...
    "cluster_nmf", "coexpr_differential", "coexpr_preservation",
    "coexpr_wgcna", "de_deseq2", "de_deseq2_results", "de_dream",
    ...
    "mae_assays", "mae_create", "mae_create_experiment",
    "mae_experiments", "mae_pull_assay", "mae_pull_experiment",
    "mae_samples", "mae_validate", "meta_effect", "ml_glmnet",
    "network_genie3", "network_genie3_links", "network_string",
    "normalize_deseq", "normalize_tmm", "qc_correlation", "qc_library",
