...
test_that("public API follows discoverable analysis families", {
  ...
  expected <- c(
    ...
    "cluster_consensus_classes", "cluster_consensus_delta_area",
    "cluster_consensus_diagnostics", "cluster_consensus_pac",
    ...
    "plot_cluster_consensus", "plot_cluster_delta", "plot_cluster_pac",
    "plot_cluster_sizes",
    "plot_coexpr_dendrogram", "plot_coexpr_membership", "plot_coexpr_modules",
    "plot_coexpr_power", "plot_coexpr_tom", "plot_coexpr_trait",
