...
test_that("public API follows discoverable analysis families", {
  ...
  expected <- c(
    ...
    "deconv_music", "deconv_reference", "drug_lincs",
    "drug_lincs_databases", "drug_lincs_example", "drug_lincs_table",
    "drug_query", "dtu_diffsplice",
    ...
    "mae_create_experiment", "mae_experiments", "mae_feature_data",
    "mae_from_matrix", "mae_pull_assay", "mae_pull_experiment",
    "mae_samples", "mae_simulate", "mae_subset_features", "mae_validate",
    ...
    "plot_gsea_ridge", "plot_lincs_heatmap", "plot_lincs_overlap",
    "plot_lincs_rank", "plot_lincs_waterfall",
    "plot_ora_bubble", "plot_ora_network",
