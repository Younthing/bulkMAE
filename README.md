...
| Regulatory activity | `activity_decouple()`, `activity_progeny()`, `activity_tf()`, `activity_contrast()`, `plot_activity_*()` | [decoupleR](https://bioconductor.org/packages/release/bioc/html/decoupleR.html) |
...
- [airway regulatory activity and plots](https://younthing.github.io/bulkMAE/articles/regulatory-activity.html)
